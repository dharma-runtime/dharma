...
## Vault (Task 64 remaining)
- Task 64.5: Vault CLI + Recovery UX (tasks/64_5_vault_cli_ux.md)
...
- Task 42b: Unified Configuration System (TOML + Env Overrides) (tasks/42_unified_config.md)
